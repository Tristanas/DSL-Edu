...
<solution name="CommonClasses" uuid="ce6ad31d-75bc-4f87-98cf-cce06e26c44d" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}/libs/minesweeper 1.4.jar!/" type="java_classes">
      <sourceRoot location="." />
      <sourceRoot location="com/zetcode/Board$MinesAdapter.class" />
      <sourceRoot location="com/zetcode/Board.class" />
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/libs/minesweeper 1.4.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
