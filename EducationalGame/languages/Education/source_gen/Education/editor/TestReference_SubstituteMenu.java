...
public class TestReference_SubstituteMenu extends SubstituteMenuBase {
  @NotNull
  @Override
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for TestReference. Generated from implicit smart reference attribute.", new SNodePointer("r:e50e3323-bf4b-4477-ac62-28fa501ce249(Education.structure)", "5724796527229380768")));
    try {
  ...
  public class SMP_ReferenceScope_tasuyn_a extends ReferenceScopeSubstituteMenuPart {
  ...
  public class SMP_Subconcepts_tasuyn_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "TestReference", null));
      try {
        return super.createItems(context);
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
