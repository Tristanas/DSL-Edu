...
public class EasyMinesweeperBoard extends JPanel implements ActionListener {
  ...
  public EasyMinesweeperBoard(JFrame fFrame, ArrayList<EasyMinesweeper.Question> questions, ArrayList<Lesson> lessons) {
  ...
  public void uncoverCell(int cellNo) {
    ...
    uncover--;
    if (field[cellNo] != MINE_CELL) {
      score += EasyMinesweeperBoard.CELL_UNCOVER_POINTS;
    }
  }
  ...
  private void handleCorrectAnswer() {
    ...
    questionsAnswered++;
    score += EasyMinesweeperBoard.CORRECT_ANSWER_POINTS;
  }
  ...
  private void handleGameOver(boolean won) {
    ...
    if (selection == JOptionPane.NO_OPTION) {
      ((EasyMinesweeper) parentWindow).showMenu();
    } else {
      newGame(true, true);
      repaint();
    }
