...
public class MathSweeperTeacher extends JFrame implements ActionListener {
  ...
  public void setupPaths() {
    File sourceLocation = new File(MathSweeperTeacher.class.getProtectionDomain().getCodeSource().getLocation().getPath());
    ImageIcon img;
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        {
          MathSweeperTeacher ex = new MathSweeperTeacher();
          ex.setVisible(true);
        }
      }
    });
