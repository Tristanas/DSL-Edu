package vu.mif.calculator.behavior;
...
public final class Calculator__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x433d109bb7724d40L, 0x88691370db4e5853L, 0x1c7d7ea6dbe715eeL, "vu.mif.calculator.structure.Calculator");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.InputField$YA)) {
      return SimpleRoleScope.forNamedElements(__thisNode__, LINKS.inputField$6aS4);
    }
    return null;
  }
